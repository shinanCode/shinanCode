module.exports = [
  {
    text: "基础",
    items: [
      { text: "数据类型", link: "/js/数据类型" },
      { text: "执行上下文", link: "/js/执行上下文" },
      { text: "原型和原型链", link: "/js/原型" },
      { text: "this指向", link: "/js/this指向" },
      { text: "new操作符", link: "/js/new操作符" },
      { text: "闭包", link: "/js/闭包" },
      { text: "继承", link: "/js/继承" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "File、Blob、Base64类型转化", link: "/js/类型转化" },
    ],
  },
  {
    text: "网络",
  ...
  },
  {
    text: "性能优化",
    items: [
      { text: "性能优化", link: "/js/性能优化" },
      { text: "图片懒加载", link: "/js/图片懒加载" },
      { text: "大文件上传", link: "/js/大文件上传" },
    ],
  },
];
